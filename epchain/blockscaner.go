...
//EPBlockScanner atom的区块链扫描器
type EPBlockScanner struct {
...
func NewATOMBlockScanner(wm *WalletManager) *EPBlockScanner {
	bs := EPBlockScanner{
...
func (bs *EPBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *EPBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *EPBlockScanner) ScanBlock(height uint64) error {
...
func (bs *EPBlockScanner) scanBlock(height uint64) (*Block, error) {
...
func (bs *EPBlockScanner) ScanTxMemPool() {
...
func (bs *EPBlockScanner) RescanFailedRecord() {
...
func (bs *EPBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *EPBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *EPBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *EPBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanTargetFunc, memPool bool) ExtractResult {
...
func (bs *EPBlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanTargetFuncV2) {
	var (
		success    = true
		multiindex = uint64(0)
	)
...
func (bs *EPBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *EPBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *EPBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *EPBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *EPBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *EPBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
func (bs *EPBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
func (bs *EPBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *EPBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *EPBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *EPBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *EPBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *EPBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *EPBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *EPBlockScanner) Restart() error {
...
func (bs *EPBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *EPBlockScanner) SupportBlockchainDAI() bool {
	return true
}
