...
func (bs *EPBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *EPBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *EPBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *EPBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *EPBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *EPBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *EPBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
