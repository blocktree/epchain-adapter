...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO EP", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WH2WNNc4ubVobAuBrEqEBkTZpTGLziwqSy")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WH2WNNc4ubVobAuBrEqEBkTZpTGLziwqSy"
	account := &openwallet.AssetsAccount{Alias: "HELLO EP", WalletID: walletID, Required: 1, Symbol: "EP", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WH2WNNc4ubVobAuBrEqEBkTZpTGLziwqSy"
	accountID := "4J3ihXXqnd9GoDNLi3fyQCTSCpr5bdCnFoYAGDKmiUwJ"
